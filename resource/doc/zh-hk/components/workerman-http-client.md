# webman/http-client
## 說明
 [webman/http-client](https://github.com/walkor/http-client) 是一個異步的HTTP客戶端組件。所有請求和響應都是異步非阻塞的，內置連接池，消息請求和響應符合PSR7規範。
...
1、項目首先要加載`require __DIR__ . '/vendor/autoload.php';`

2、所有的異步代碼只能在webman啟動後的運行環境運行

3、支援基於webman開發的所有項目，包括GatewayWorker、PHPSocket.io等
